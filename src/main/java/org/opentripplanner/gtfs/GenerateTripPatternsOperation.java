...
public class GenerateTripPatternsOperation {
    ...
    public GenerateTripPatternsOperation(GtfsDao dao, AddBuilderAnnotation builderAnnotation,
            Deduplicator deduplicator, CalendarService calendarService) {
        this.dao = dao;
        this.builderAnnotation = builderAnnotation;
        this.deduplicator = deduplicator;
        this.calendarService = calendarService;
        this.tripPatterns = dao.getTripPatterns();
    }

    public void run() {
        collectFrequencyByTrip();

        final int tripsSize = dao.getAllTrips().size();
    ...
    private void collectFrequencyByTrip() {
        for(Frequency freq : dao.getAllFrequencies()) {
